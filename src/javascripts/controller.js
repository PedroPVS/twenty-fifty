(function () {
    ...
    switchView = function (new_view) {
        ...
        if (view === "costs_in_context") {
            $("#cost_choice").addClass("selectedView").text("Custos: contexto");
        } else if (view === "costs_compared_overview") {
            $("#cost_choice").addClass("selectedView").text("Custos: comparativo");
        } else if (view === "costs_sensitivity") {
            $("#cost_choice").addClass("selectedView").text("Custos: sensibilidade");
        } else {
            $("#cost_choice").text("Custos");
        }
        active_view.setup();
        c = codeForChoices();
        data = cache[c];
