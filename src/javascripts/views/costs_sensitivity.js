window.twentyfifty.views.costs_sensitivity = function () {
    ...
    this.drawChart = function () {
        ...
        this.increment_arrows = {
            ...
            range_message: r.text(0, y('i') + bar_height / 2, "Alguns custos são incertos, portanto, o seu caminho poderia ser entre").attr({
                'text-anchor': 'end'
            }),
