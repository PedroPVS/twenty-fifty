window.timeSeriesStackedAreaChart = function () {
    ...
    color_classes = {
        //Mapeamento das classes CSS para o contexto de apresentação Brasil
        'Transportes': 'transportes',
        'Setor residencial': 'setor-residencial',
        'Setor comercial/público': 'setor-comercial-publico',
        'Setor industrial': 'setor-industrial',
        'Setor energético': 'setor-energetico',
        'Setor agropecuário': 'setor-agropecuario',
        'Consumo final não energético': 'consumo-final-nao-energetico',
        'Derivados de petróleo': 'derivados-de-petroleo',
        'Gás Natural': 'gas-natural',
        'Carvão e derivados': 'carvao-e-derivados',
        'Nuclear': 'nuclear',
        'Outras não renováveis': 'outras-nao-renovaveis',
        'Solar': 'solar',
        'Eólica': 'eolica',
        'Hidráulica': 'hidraulica',
        'Biomassa': 'biomassa',
        'Produtos da cana': 'produtos-da-cana',
        'Oceanos': 'oceanos',
        'Eficiência energética': 'eficiencia-energetica',
        'Emissões (energia)': 'emissoes-energia',
        'Sequestro de carbono': 'sequestro-de-carbono',
        'Total': 'total',
        'Total¹': 'total',
        'Total (energia)': 'total',
        'Geração elétrica': 'geracao-eletrica',
        'Bioenergia': 'bioenergia',
        'Produção bruta de petróleo': 'producao-bruta-de-petroleo',
        'Produção bruta de gás natural': 'producao-bruta-de-gas-natural',
        'Produção bruta de carvão': 'producao-bruta-de-carvao',
        'Oferta interna de óleo': 'oferta-interna-de-oleo',
        'Produção líquida de gás natural': 'producao-liquida-de-gas-natural',
        'Produção líquida de carvão': 'producao-liquida-de-carvao'
    };
    ...
    xAxis = d3.svg.axis().scale(xScale).orient("bottom").tickValues([2020, 2030, 2040, 2050]).tickFormat(d3.format(".0f"));
